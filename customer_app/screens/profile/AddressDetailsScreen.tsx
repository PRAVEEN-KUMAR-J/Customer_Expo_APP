...
export const AddressDetailsScreen: React.FC = () => {
  ...
  const editIndex: number = params.index != null ? parseInt(params.index, 10) : 0;
  const editingAddress = isEdit && addresses[editIndex] ? addresses[editIndex] : undefined;

  const prefillStreet: string | undefined = params.street;
  const prefillCity: string | undefined = params.city;
  const prefillDistrict: string | undefined = params.district;
  const prefillPincode: string | undefined = params.pincode;
